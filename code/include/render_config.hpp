...
constexpr int DEFAULT_PATH_GUIDING_S0 = 32;
constexpr int DEFAULT_PATH_GUIDING_S1 = 96;
constexpr int DEFAULT_PATH_GUIDING_GRID_RESOLUTION = 8;
constexpr int DEFAULT_PATH_GUIDING_MAP_RESOLUTION = 32;
constexpr float DEFAULT_PATH_GUIDING_PMAX = 0.5f;
...
struct RenderConfig {
    ...
    int pathGuidingS0 = DEFAULT_PATH_GUIDING_S0;
    int pathGuidingS1 = DEFAULT_PATH_GUIDING_S1;
    ...
    float pathGuidingPMax = DEFAULT_PATH_GUIDING_PMAX;
